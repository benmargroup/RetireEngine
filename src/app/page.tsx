...
export default function HomePage() {
  return (
    <main className="flex min-h-screen items-center justify-center bg-cream">
      <div className="mx-auto max-w-2xl px-6 py-8 text-center sm:py-16">
        {/* Eyebrow */}
        ...
        <div className="mx-auto mt-6 max-w-xl rounded-2xl border border-sage-light/40 bg-white px-6 py-5 shadow-sm sm:mt-10 sm:px-8 sm:py-7">
        ...
        {/* Trust signals */}
        <div className="mt-6 flex flex-wrap items-center justify-center gap-x-3 gap-y-2 border-t border-sage-light/30 pt-5 text-base font-medium text-navy sm:mt-12 sm:pt-8">
